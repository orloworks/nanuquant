"""Trading metrics for polars_metrics.
...
from polars_metrics.core.distribution import skewness
from polars_metrics.core.returns import avg_loss, avg_win, comp, win_rate
from polars_metrics.core.risk import var
...
def serenity_index(returns: pl.Series) -> float:
    ...
    """
    from polars_metrics.core.returns import cagr
    from polars_metrics.core.risk import ulcer_index
...
def adjusted_sortino(
    ...
    *,
    ...
    2.5...
    """
    from polars_metrics.core.distribution import kurtosis
    from polars_metrics.core.performance import sortino
...
def smart_sharpe(
    ...
    *,
    ...
    1.5...
    """
    from polars_metrics.core.performance import sharpe
