"""Performance ratio metrics for polars_metrics.
...
from polars_metrics.core.returns import cagr, comp
...
def common_sense_ratio(returns: pl.Series) -> float:
    ...
    6.25...
    """
    from polars_metrics.core.returns import profit_factor as pf
