"""Polars Expression Namespace plugin for polars_metrics.
...
class MetricsNamespace:
    ...
    This namespace provides access to polars_metrics functions directly on
    ...
    --------
    >>> import polars as pl
    >>> import polars_metrics as pm  # Registers the namespace
    >>>
    >>> df = pl.DataFrame({"returns": [0.01, -0.02, 0.015, -0.01, 0.02] * 50})
    >>>
    >>> # Single metric
    ...
    def downside_deviation(
        ...
        from polars_metrics.core import downside_deviation
    ...
    def sharpe(
        ...
        from polars_metrics.core import sharpe
    ...
    def sortino(
        ...
        from polars_metrics.core import sortino
    ...
    def calmar(self, *, periods_per_year: int = 252) -> pl.Expr:
        ...
        from polars_metrics.core import calmar
    ...
    def omega(
        ...
        *,
        ...
        from polars_metrics.core import omega
    ...
    def gain_to_pain_ratio(self) -> pl.Expr:
        ...
        from polars_metrics.core import gain_to_pain_ratio
    ...
    def ulcer_performance_index(self, *, risk_free_rate: float = 0.0) -> pl.Expr:
        ...
        from polars_metrics.core import ulcer_performance_index
    ...
    def skewness(self) -> pl.Expr:
        """Calculate skewness."""
        from polars_metrics.core import skewness

        return self._apply_metric(skewness)

    def kurtosis(self, *, excess: bool = True) -> pl.Expr:
        """Calculate kurtosis."""
        from polars_metrics.core import kurtosis
    ...
    def expected_return(self, *, periods_per_year: int = 252) -> pl.Expr:
        ...
        from polars_metrics.core import expected_return
    ...
    def geometric_mean(self) -> pl.Expr:
        ...
        from polars_metrics.core import geometric_mean
    ...
    def consecutive_wins(self) -> pl.Expr:
        ...
        from polars_metrics.core import consecutive_wins
    ...
    def consecutive_losses(self) -> pl.Expr:
        ...
        from polars_metrics.core import consecutive_losses
